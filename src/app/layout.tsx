...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head>
        <link href="https://fonts.googleapis.com/css2?family=Cal+Sans:wght@600;700&family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&display=swap" rel="stylesheet" />
      </head>

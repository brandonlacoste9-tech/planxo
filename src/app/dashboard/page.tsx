  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.section}>
        <h2 style={styles.h2}>Calendriers connectés</h2>
        <p style={styles.muted}>Connectez vos calendriers pour synchroniser vos disponibilités en temps réel.</p>
        ...
        <p style={{ fontSize: 12, color: "#898989", marginTop: 8 }}>
          Google: définissez GOOGLE_CLIENT_ID + GOOGLE_CLIENT_SECRET · Outlook: OUTLOOK_CLIENT_ID + OUTLOOK_CLIENT_SECRET
        </p>
      </div>
